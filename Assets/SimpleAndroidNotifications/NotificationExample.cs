...
namespace Assets.SimpleAndroidNotifications
{
    public class NotificationExample : MonoBehaviour
    {
        ...
        {
            NotificationManager.SendWithAppIcon(TimeSpan.FromSeconds(GiftTimer.fourHour), Strings.mainNotif, Strings.secondNotif, new Color(0, 0.6f, 1), NotificationIcon.Message);
        }
